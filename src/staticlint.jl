import StaticLint: hasfile, canloadfile, loadfile, setfile, getfile, getsymbolserver, getsymbolextendeds, getsymbolfieldtypemap
...
getsymbolfieldtypemap(server::LanguageServerInstance) = server.symbol_fieldtypemap
